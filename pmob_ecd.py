...
$ Analysis Type   : Dynamic Stiffness 
$ Description     : None
...
ECHO=NONE
MAXLINES=10000000
TITLE = Dynamic Stiffness {FULLNAME}
$ITLE   
$
METHOD=10
FREQ=10
...
#Adds "INCLUDE" for the chosen material cards. Does nothing to the material cards not chosen.
def add_include(materialCard): 
	if materialCard != '':
...
def generate_output(grid_values, spc_value,nasFile, material1, material2, material3):
	...
	for grid in grid_values:
		...
		dload_output += DLOAD_TEMP.format(GRID7 = grid.rjust(7),
										GRID6 = grid.rjust(6))
...
def main(): 
	...
	ecdFile = 'pmob_' + nasFile1.split('.')[0] + '.ecd'
